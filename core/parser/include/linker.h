...
namespace Pulse::Parser
{
    ...
    public:
        ...
        LinkedDesign link(const std::vector<ASTRoot>& astRoots);
    ...
    private:
        ...
        void collectEntities(const std::vector<ASTRoot>& astRoots);
        void resolveArchitectures(const std::vector<ASTRoot>& astRoots, LinkedDesign& outputDesign);
