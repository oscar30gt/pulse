...
namespace Pulse
{
    Adder::Adder(Wire* in0, Wire* in1, Wire* out)
        ...
        m_in0(in0->width(), this, &Adder::recalculate),
        m_in1(in0->width(), this, &Adder::recalculate),     // Must have the same width as in0
    ...
    { 
        ...
        {
            throw bit_width_mismatch("Adder construction failed: " + std::string(e.what()));
        }
    }

    Adder::~Adder() = default;

    bool Adder::recalculate(ttl_t ttl)
    {
